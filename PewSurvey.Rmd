...
Then upload the file called "January 3-10, 2018 - Core Trends Survey - CSV.csv" to the Files section of R Studio. Do this by clicking the 'Upload' button in the Files window pane on the right.
...
Here is a line ended with two spaces.  
Here is the next line.

Here is a line ended with one space. 
Here is the next line.
...
Make a list with indentations and number/letter symbols. Use 4 spaces to make the sub-lists:
...
You can suppress the code so it runs but does not show when published by putting include=FALSE in the brackets:
...
You can insert R code without a chunk by surrounding it in backticks and using the letter r, like this: 2 + 2 + 1 = `r x + y + 1` 



Those are some of the basics of R Markdown. Now let's get on with the analysis of the Pew data.
